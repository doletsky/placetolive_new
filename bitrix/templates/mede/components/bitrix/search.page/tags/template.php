...
<?elseif(count($arResult["SEARCH"])>0):?>
	...
	<?foreach($arResult["SEARCH"] as $arItem):?>
		<a class="search_title" href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a>
        <a href="<?echo $arItem["URL"]?>"><img src="<?echo $arItem["PIC"]?>" style="float: left; width: 300px; height: auto; margin-right: 20px;"></a>
		<p><?echo $arItem["TEXT"]?></p>
