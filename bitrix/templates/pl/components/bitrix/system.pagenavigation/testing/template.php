...
<a class="blog-page-next" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>">Ответить</a>
<?else:?>
<a class="blog-page-next" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN=0">Ответить</a>
<?endif?>
<?
if(0):
$strNavQueryString = ($arResult["NavQueryString"] != "" ? $arResult["NavQueryString"]."&amp;" : "");
